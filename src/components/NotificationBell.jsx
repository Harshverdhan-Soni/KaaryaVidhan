...
export default function NotificationBell({ me, onOpenTask }) {
  ...
  return (
    <div className="relative" ref={boxRef}>
      <button className="relative grid h-9 w-9 place-items-center rounded-lg text-ink hover:bg-sky"
      ...
      {open && (
        <>
          ...
          <div className="fixed left-3 right-3 top-[4.25rem] z-50 max-h-[75vh] overflow-hidden rounded-xl border border-line bg-surface shadow-xl
